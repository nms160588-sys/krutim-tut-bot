            ...
            for update in updates.get("result", []):
                ...
                if text.startswith("/start"):
                    send_message(chat_id,
                        ...
                        "Вот пошаговый старт:\n\n"
                        "1. Помещение:\n"
                        "Ищи локацию с высоким трафиком (ТЦ, транспортные узлы, бизнес-центры).\n"
                        "Площадь: 15-25 м2 + зона ожидания.\n"
                        "Оборудование: фритюрница, шаурмоварка (2-3 позиции), холодильник, мойка.\n\n"
                        "2. Команда:\n"
                        "Нанимай 3-4 человека на старте (менеджер + кассиры).\n"
                        "Пройди обучение в головном офисе.\n"
                        "Система мотивации: фикс 200р/час + бонусы за выручку + премия за средний чек.\n\n"
                        "Задача на сегодня: напиши мне свое имя, город и когда ты свободен на звонок."
                    )
                else:
                    reply = ask_ai(text)
